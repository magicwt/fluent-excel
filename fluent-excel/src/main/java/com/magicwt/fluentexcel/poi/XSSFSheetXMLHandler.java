...
/**
 * This class handles the processing of a sheet#.xml sheet part of a XSSF .xlsx file, and generates
 * row and cell events for it.
 *
 * 原代码是{@link org.apache.poi.xssf.eventusermodel.XSSFSheetXMLHandler}
 *
 * 这里fork一份，是为了扩展{@link SheetContentsHandler}接口，添加了beginSheet和endSheet方法，用于处理sheet开始和结束
 *
 * @author magicwt
 */
public class XSSFSheetXMLHandler extends DefaultHandler {
  ...
  /**
   * These are the different kinds of cells we support. We keep track of the current one between the
   * start and end.
   */
  enum xssfDataType {
    BOOLEAN,
